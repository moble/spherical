...
def multiply(f, ellmin_f, ellmax_f, s_f, g, ellmin_g, ellmax_g, s_g, ellmin_fg=None, ellmax_fg=None):
    ...
    ellmin_fg = ellmin_fg if ellmin_fg is not None else min(ellmin_f, ellmin_g)
